...
const Hero = () => {
  ...
  const data = useStaticQuery(graphql`
    {
      photo: file(relativePath: { eq: "pratyushPhoto2.png" }) {
        childImageSharp {
          fluid(maxWidth: 512) {
      ...
      logo: file(relativePath: { eq: "pratyushTitle.png" }) {
        childImageSharp {
          fluid(maxHeight: 128) {
            ...GatsbyImageSharpFluid_withWebp_noBase64
          }
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-5 gap-y-8 lg:gap-16 justify-center lg:justify-start items-center mt-8 md:mt-12 lg:mt-0">
        ...
        <div className="col-span-3">
          ...
          <h1 className="sr-only">
            Pratyush&apos;s Resume on the Web <br />
            Designer, Developer, Photographer, Blog Writer, India
          </h1>
